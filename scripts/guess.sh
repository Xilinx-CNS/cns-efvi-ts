...
# Script should be used as source to guess TE/conf/Onload TS libs/TS parameters if they're not
...
for loop in once ; do
    ...
    echo "Cannot import path to test-environment directory '$TE_BASE'" >&2
    exit 1
done
